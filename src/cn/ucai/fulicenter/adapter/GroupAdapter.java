...
//	}
	public GroupAdapter(Context context, int res,ArrayList<GroupBean> groupList) {
...
//					getFilter().filter(s);
			...
			UserUtils.setGroupBeanAvatar(getItem(position).getName(), (NetworkImageView) convertView.findViewById(R.id.avatar));
